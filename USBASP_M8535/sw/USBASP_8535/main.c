...
/*
	DDRA |= 0b00111000;
	for(uint8_t tstVal = 0;; ++tstVal)
	{
		if ((tstVal & 0x00000001) != 0)
		{
			PORTA |= 0b00111000;	
		}
		else
...
//	for(;;);
	...
	// @#$@#$@#$@#$@#$ TEST #$%@#$%@#$@#$@#@#$
	//DDRC |= 0b00000010;
	//volatile int breakCycle = 0;
	//for(;breakCycle == 0;)
	
// 	asm volatile ("LDI r16, 0b00000010");
// 	asm volatile ("LDI r17, 0b11111101");
// 	asm volatile ("LL1: out 0x15, r16");
// 	asm volatile ("out 0x15, r17");
// 	asm volatile ("out 0x15, r16");
// 	asm volatile ("out 0x15, r17");
// 	asm volatile ("out 0x15, r16");
// 	asm volatile ("out 0x15, r17");
// 	asm volatile ("out 0x15, r16");
