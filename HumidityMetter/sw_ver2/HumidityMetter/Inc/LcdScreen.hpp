...
void LcdPrintNumber(const uint8_t valueToPrint, const bool leftAligned = false);
void LcdPrintNumber(const uint16_t valueToPrint, const bool leftAligned = false);
void LcdPrintNumber(const uint32_t valueToPrint, const bool leftAligned = false);
